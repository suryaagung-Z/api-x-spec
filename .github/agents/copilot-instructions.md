...
- 002-event-management: Added Python 3.11+ + FastAPI, SQLAlchemy 2.x async, Alembic 1.13, Pydantic v2 (with `AwareDatetime`, `computed_field`), pydantic-settings, asyncpg (prod), aiosqlite (dev/test)
